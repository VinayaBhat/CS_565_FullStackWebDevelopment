...
3. On running `node app.js` in the command prompt, the server is started and is listening on port 8080. 
   ...
   `http://localhost:8080/` displays the form. After filling out the contents if we enter submit the contents of the form is displayed on `http://localhost:8080/submit`
